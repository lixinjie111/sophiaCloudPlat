...
<div class="c-padding-10">
    ...
    <div class="opContent  c-mt-20 c-mb-10" v-show="currentId==2">
      ...
      <el-form ref="dialogForm" :model="formParams" label-width="100px" size="mini" :rules="rules" label-position="top">
        ...
        <el-form-item label="检验值"  prop='check' >
          <el-input v-model="formParams.check" placeholder="请输入"></el-input>
        </el-form-item>
        <el-form-item label="分析设置" prop="type">
          <el-checkbox-group v-model="formParams.type">
            <el-checkbox label="normal" name="normal" >正态分布检测</el-checkbox>
          </el-checkbox-group>
        </el-form-item>
      </el-form>
       <div class="c-text-center">
...
import {tSingle,checkData} from '@/api/deduce';
  export default {
    data() {
      return {
          formParams: {
