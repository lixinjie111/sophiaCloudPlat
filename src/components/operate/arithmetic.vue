    ...
    <div class="opContent c-mt-20 c-mb-10 box" v-show="currentId === 2">
      <div class="opContent-col-row">
        ...
        <span class="opContent-col-item">
          <el-select :multiple="true" v-model="encoder.oneHot" placeholder="请选择" style="width: 80%;" class="opContent-col-item-select">
            <el-option
      ...
      <div class="opContent-col-row">
        ...
        <span class="opContent-col-item">
          <el-select :multiple="true" v-model="encoder.factorize" placeholder="请选择" style="width: 80%;" class="opContent-col-item-select">
            <el-option
              v-for="item in options"
              :key="item.key"
              :disabled="disabledOptions.includes(item.value)"
...
<script>
  ...
  import {submitAlgorithm} from '@/api/dataDeal/index'
