  ...
  export default {
    data() {
      return {
          formParams: {
            ...
            show_options:['report','matrix','roc','r2','coff','independence','resid_normal','pp','qq','var','vif','outliers','pred_y_contrast'],
          },
          typeList:[//操作类型
            {name:'训练',value:'1'},
            {name:'测试',value:'2'},
    ...
    created(){
      if(this.$route.params.rowData){
        ...
        this.formParams.yan =parameterConfig.cv?parameterConfig.cv:'';
        this.formParams.penalty=parameterConfig.param.penalty?parameterConfig.param.penalty:[];
        ...
        this.formParams.max_iter=parameterConfig.param.max_iter?parameterConfig.param.max_iter.join(','):'';
