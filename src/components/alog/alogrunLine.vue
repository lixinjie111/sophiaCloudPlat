...
import {train,lineTrain} from '@/api/algorithm';
  ...
  export default {
    ...
    created(){
      if(this.$route.params.rowData){
        ...
        this.formParams.fit_intercept=parameterConfig.param.fit_intercept?parameterConfig.param.fit_intercept:true;
