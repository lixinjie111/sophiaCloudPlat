                    ...
                    <div class="c-mt-20 c-mb-20" v-if="resFlag">
                        <div id="pdfDom"> 
                            <div >
                                ...
                                <div v-for="(item,index) in resultArr" :key="index" v-if="!item.is_test" class="c-mb-60">
                                    <div v-if="item.str" > 
                                        <p style="text-align:center;" class="c-fontTitle">{{item.title}}</p>
                                        <p style="text-align:center;" class="c-padding-10 cmm-wrapper" v-html="item.str"></p>
                                    </div>
                                    ...
                                    <div v-if="item.col" >
                                        <p style="text-align:center;"  class="c-mb-20 c-fontTitle">{{item.title}}</p>
                                        <vxe-table
                                            border
                                            stripe
                                            align="center"
                            ...
                            <div style="height:2px;background:#f00" class="c-mb-60"></div>
                            <div>
                                ...
                                <div v-for="(item,index) in resultArr" :key="index" v-if="item.is_test" class="c-mb-60">
                                    ...
                                    <div v-if="item.col">
                                        ...
                                        <p style="text-align:left;" class="c-padding-10 c-fontDesc" v-if="item.remarks">{{item.remarks}}</p>
                                    </div>
                                </div> 
                            </div>
                        </div> 
...
export default {
    ...
    methods: {
        ...
        getRes(res){
            ...
            this.saveData={
                data:res.model_info,
                model_info2:res.model_info2?res.model_info2:null,
                title:'逻辑回归算法训练',
                dom:'pdfDom',
