                    ...
                    <div class="contentStep">
                        ...
                        <div  class="c-detail-box" v-if="dataListObj">
                            <vxe-table
                                ...
                                max-height="400"
                                :edit-config="{trigger: 'click', mode: 'cell'}">
                                <vxe-table-column  sortable  :field="subItem" :title="subItem" v-for="(subItem,subIndex) in dataListObj.nameList" :key="subIndex" :edit-render="{name: 'input', immediate: true, attrs: {type: 'text'}}"></vxe-table-column>
                            </vxe-table>
                        </div>
                        <div class="c-text-center c-padding-20">
