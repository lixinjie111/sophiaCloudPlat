<template>
    <div class="c-wrapper-20">
         <div class="c-button-wrapper c-text-left">
            ...
            <el-button size="mini" plain @click="handleAdd()">两表合并</el-button>
            <el-button size="mini" plain @click="handleMore()">多表合并</el-button>
        ...
        <more-merge v-if="MoreMergeFlag" @closeDialog="closeDialog"></more-merge>
...
import moreMerge from './components/moreMerge';
