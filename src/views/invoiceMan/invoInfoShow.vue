<template>
  <div class="invoiceInfoMan_con">
    <div class="invoice_info">发票信息有效 &nbsp;<span @click="editInvoiceInfo">修改发票信息</span></div>
    <div class="invoice_con">
      ...
      <div class="company" v-if="IssuType === 'company'">
        ...
        >
          <el-form-item label="发票抬头：">
            <el-input
              v-model="qiyeInvInfo.invoiveTitle"
              disabled
            ></el-input>
          </el-form-item>
          <el-form-item label="开具类型：">
            <el-input
              v-model="qiyeInvInfo.invoivekjType"
              disabled
            ></el-input>
          </el-form-item>
          <el-form-item label="发票类型：">
            <el-input
              v-model="qiyeInvInfo.invoiveType"
              disabled
            ></el-input>
          </el-form-item>
          <el-form-item label="纳税人识别号：">
            <el-input
              v-model="qiyeInvInfo.TaIdeNum"
              disabled
            ></el-input>
          </el-form-item>
          <el-form-item label="开户银行名称：">
            <el-input
              v-model="qiyeInvInfo.khBankName"
              disabled
            ></el-input>
          </el-form-item>
          <el-form-item label="开户账号：">
            <el-input
              v-model="qiyeInvInfo.khBankNumber"
              disabled
            ></el-input>
          </el-form-item>
          <el-form-item label="注册场所地址：">
            <el-input
              v-model="qiyeInvInfo.regAdderss"
              disabled
            ></el-input>
          </el-form-item>
          <el-form-item label="注册固定电话：">
            <el-input
              v-model="qiyeInvInfo.regFixtelnum"
              disabled
            ></el-input>
          </el-form-item>
        </el-form>
